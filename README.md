...
- **Code blocks** (fenced with ` ``` ` or `~~~`) with syntax highlighting for C, C++, Java, Kotlin, JavaScript, TypeScript, C#, Visual Basic .NET, JSON, Bash, Python, SQL, Gherkin, and XML/HTML
